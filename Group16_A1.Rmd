...
p1 <- df_longer %>%
  ...
  geom_line() +
  ggtitle("Posterior Distribution: Proportion of Undergraduate Students Who Passed") +
  geom_vline(xintercept=0.7007, color="red", linetype = "dashed") +
  annotate("text", x = 0.48,  
           y = 7.5, label = "Posterior mean = 0.7", color = "red", 
           size = 4) +
...
p2 <- df_longer %>%
  ...
  ggplot(aes(x = theta, y = density,
             colour = distribution, fill = distribution)) +
  geom_line() +
  ggtitle("Posterior Distribution: Proportion of Postgraduate Students Who Passed") +
  geom_vline(xintercept=0.85, color="red", linetype = "dashed") +
  annotate("text", x = 0.6,  
           y = 6, label = "Posterior mean = 0.84", color = "red", 
           size = 4) +
  scale_fill_manual(values=cbbP) +
  theme_bw()
...
ds3 %>% 
  ...
  annotate("text", x = 0, y = 6, 
           label = 
             expression(paste("Probability ", Delta, " within +/- 0.15 = 0.55")),
           color = "red", size = 4) +  
